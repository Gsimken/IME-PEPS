...
cat("\n\nGráfico de caja para el análisis de las variables")
print(pbf)
...
# con una exactitud de aproximadamente el 84%, sin embargo, la sensibilidad
# no es tan alta.
...
# Se puede ver que además de la sensibilidad y especificidad la exactitud
# del modelo aumenta considerablemente al utilizar la función train() para
# entrenar al modelo (modelo 1: 0,84 - modelo 2: 0.91) alcanzando una 
# exactitud de alrededor del 91%, lo cual cumple con lo solicitado en la 
# pregunta
