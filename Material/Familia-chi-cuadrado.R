...
# Para esto existe un procedimiento χ^2, que se le conoce de forma 
# general como Prueba χ^2 de Asociación, aunque a veces también se 
# distinguen dos pruebas distintas: la Prueba χ^2 de Homogeneidad y la 
# Prueba χ^2 de Independencia. La diferencia es más bien conceptual, 
# no matemática, y tiene relación con cómo se miren las variables y las
# poblaciones involucradas en el problema.
# 
# Este caso parece enfrentarse mejor como una Prueba χ^2 de Homogeneidad,
...
# Menos correcto, pero posible, sería verlo como una Prueba χ^2 de
...
χ.cuadrado.test <- chisq.test(x = tabla.obs)

cat("\n\n")
cat("Prueba χ^2 de Homogeneidad entre algorirtmos y más de una búsqueda\n")
cat("------------------------------------------------------------------\n")
print(χ.cuadrado.test)
# stop()
...
# Prueba χ^2 de Asociación toma mejor más la idea de una Prueba χ^2 de
# Independencia.
...
cat("\n\n")
cat("Prueba χ^2 de Independencia entre café y depresión\n")
cat("--------------------------------------------------\n")
print(χ.cuadrado.test)
# stop()
...
# Nuevamente podemos pensar en una Prueba χ^2 de Homogeneidad, puesto
...
cat("\n\n")
cat("Prueba χ^2 de Homogeneidad entre Chile y países con PIB similar\n")
cat("---------------------------------------------------------------\n")
print(χ.cuadrado.test)
# stop()
...
# Este problema también puede enfrentarse con un procedimiento χ^2,
...
# que permite, siguiendo la misma matemática, obtener un estadístico χ^2.
...
cat("\n\n")
cat("Prueba χ^2 de Bondad del Ajuste según proporciones 2007\n")
cat("-------------------------------------------------------\n")
print(χ.cuadrado.test.2007)
