...
# 
# Los β's son los parámetros de la combinación lineal que relaciona
...
# estimaciones de los parámetros β0, β1, β2, ..., βk, de tal
# forma que si 
# 
...
# Hay que notar que los β's, y sus estimaciones b's, tienen apellido:
# "parciales".
# β_i no es lo mismo que el β que resulta de la regresión de Y en
# Xi.
...
# β). Claro que hay muchas formas de ajustar R^2, y ¡con varios
