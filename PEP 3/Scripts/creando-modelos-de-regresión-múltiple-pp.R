...
basename <- "MisArchivos/Usach/Inferencia/Scripts Profe pep 3/body.csv"
...
#
#     Y = (β0 + β1·mu_Y|X1 + β2·mu_Y|X2 + ... + βk·mu_Y|Xk) + error
#
# que se estimaba consiguiendo aproximaciones a los parámetros β:
#
...
#   (generalmente el modelo nulo, con todos los β's en cero, y que
...
cat("----------------------------------------------\n")
cat("observacion en la posicion:",sospechosos1, " es un sospechoso")
...
# Es decir, los coeficientes β estimados por el modelo ¡no son
# confiables!
# ¿Qué hacemos?
