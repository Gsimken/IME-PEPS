...
# Las pruebas χ^2 que se usan con la regresión logística, por
...
# El estadístico desviación sigue una distribución χ^2, lo que permite
...
# diferencia también sigue una χ^2.
